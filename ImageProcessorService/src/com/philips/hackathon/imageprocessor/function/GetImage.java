 ...
 */
public class GetImage implements RequestHandler<ServerlessInput, ServerlessOutput> {
    ...
    public ServerlessOutput handleRequest(ServerlessInput serverlessInput, Context context) {
        ...
        try {
            ...
            Map<String, AttributeValue> item = dynamoDb.getItem(new GetItemRequest()
                    ...
                    .withKey(key))
                    .getItem();
            String s3ObjectKey = item.get(IMAGE_TABLE_KEY_NAME).getS();
            String content = IOUtils.toString(s3.getObject(new GetObjectRequest(IMAGE_BUCKET_NAME, s3ObjectKey)).getObjectContent());
